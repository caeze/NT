...
public class Preferences {
	...
	public String projectLocation = "http://caeze.bplaced.net/nt/";
	...
	public void persist() {
		try {
			...
			props.setProperty("lastOpenedProjectPath", lastOpenedProjectPath);
	...
	public void load() {
		try {
			...
			lastOpenedProjectPath = props.getProperty("lastOpenedProjectPath", lastOpenedProjectPath);
		} catch (Exception e) {
			Log.error(Preferences.class, e.getMessage());
		}
	}
